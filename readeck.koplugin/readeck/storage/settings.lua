...
function Settings.install(Readeck)
    function Readeck:saveSettings()
        local tempsettings = {
            ...
            experimental_async_downloads_opt_in_version = self.experimental_async_downloads_opt_in_version,
            auto_export_highlights = self.auto_export_highlights,
            export_highlights_before_sync = self.export_highlights_before_sync,
            highlight_conflict_policy = self.highlight_conflict_policy,
            highlight_feature_policy = self.highlight_feature_policy,
            ...
            browse_apply_sync_filters = self.browse_apply_sync_filters,
            browse_catalog_max_age_hours = self.browse_catalog_max_age_hours,
